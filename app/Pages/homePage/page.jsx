  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex gap-4 pt-10 pl-10">
        ...
        <div onClick={()=>router.push('https://www.manipalcommunityconnect.in/specialities/all')} className="w-[150px] h-[120px] border border-[#14b8a6] flex items-center justify-center rounded-xl font-semibold text-[#14b8a6] cursor-pointer px-5 min-w-max">
          View All
        </div>
      </div>
      <div className=" p-10">
          ...
          {trendingDiscussionData.map((item) => (
            <div className="flex gap-3 w-[614px]" key={item.id}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button onClick={()=>router.push('https://www.manipalcommunityconnect.in/forum/healthy-brain-corresponds-to-a-healthy-heart-the-heart-of-living-healthy')} className="w-36 h-10 bg-gradient-to-r from-blue-600 to-green-600 font-semibold text-base text-white rounded-xl hover:bg-gradient-to-r hover:from-green-600 hover:to-blue-600">
                  Join Now
                </Button>
              </div>
            </div>
        ...
        <div className="flex justify-center pt-10 pb-10">
          <Button onClick={()=>router.push('https://www.manipalcommunityconnect.in/forum/trending?search=')} className="w-44 h-12 bg-white border border-blue-800 font-semibold text-blue-800 text-lg rounded-xl hover:bg-blue-600 hover:text-white">
            View All
          </Button>
        </div>
      </div>
      <div className="p-10">
          ...
          {blogsData.map((item) => (
            <div className="flex flex-col w-[300px]" key={item.id}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <p className="underline text-green-600">Read More</p>
                </div>
                <div className="flex">
                  <div className="flex gap-2">
        ...
        <div className="flex justify-center pt-10 pb-10">
          <Button onClick={()=>router.push('https://www.manipalcommunityconnect.in/blog?search=')} className="w-44 h-12 bg-white border border-blue-800 font-semibold text-blue-800 text-lg rounded-xl hover:bg-blue-600 hover:text-white">
            View All
          </Button>
        </div>
      </div>
